...
#define CUSTOM_MENDEL_NAME "Rostock"
...
#define DEFAULT_DELTA_DIAGONAL_ROD 188.28 // mm
...
#define Z_PROBE_OFFSET {-5, 46.80, 19.4, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.
...
#define AUTO_BED_LEVELING_GRID
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -46.8
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -19.4
...
#define MANUAL_Z_HOME_POS 552.5 // For delta: Distance between nozzle and print surface after homing.
...
//E_steps = motor_steps_per_rev * driver_microstep * big_gear_teeth / small_gear_teeth / PI / hob_effective_diameter 
// E_steps = 200 * Whatever your Microstep is * 45 / 11 / 3.14159 / 7
//548
