...
#define CUSTOM_MACHINE_NAME "Rostock"
...
#define DELTA_DIAGONAL_ROD 188.28 // mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 164.5 // mm
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 218.24
    #define  DEFAULT_bedKi 24.44
    #define  DEFAULT_bedKd 487.20
...
// #define Z_PROBE_REPEATABILITY_TEST // Z-Probe Repeatability test is not supported in Deltas yet.
  ...
  #define AUTO_BED_LEVELING_GRID  // Deltas only support grid mode
    ...
    #define FRONT_PROBE_BED_POSITION -DELTA_PROBABLE_RADIUS+30
    ...
    #define AUTO_BED_LEVELING_GRID_POINTS 6
      ...
      #define ABL_PROBE_PT_1_X -86.6
      #define ABL_PROBE_PT_1_Y -50.0
      #define ABL_PROBE_PT_2_X 86.6
      #define ABL_PROBE_PT_2_Y -50.6
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -6     // Probe on: -left  +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 26   // Probe on: -front +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -13.10  // -below (always!)
  ...
  #define Z_RAISE_AFTER_PROBING 25    //How much the extruder will be raised after the last probing point.
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 551. // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80,  561.19}  // default steps per unit for Kossel (GT2, 20 tooth)
